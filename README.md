...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/prometheus | 56MB | 1000:1000 | ✅ | amd64, arm64, armv7 |
| prom/prometheus | 261MB | 65534:65534 | ❌ | amd64, arm64, armv7, ppc64le, riscv64, s390x |
  ...
  prometheus:
    depends_on:
      adguard:
        ...
        restart: true
    image: "11notes/prometheus:3.14.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
      PROMETHEUS_CONFIG: |-
...
* [3.14.0](https://hub.docker.com/r/11notes/prometheus/tags?name=3.14.0)
* [3.14.0-unraid](https://hub.docker.com/r/11notes/prometheus/tags?name=3.14.0-unraid)
* [3.14.0-nobody](https://hub.docker.com/r/11notes/prometheus/tags?name=3.14.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/prometheus:3.14.0
docker pull ghcr.io/11notes/prometheus:3.14.0
docker pull quay.io/11notes/prometheus:3.14.0
```
...
*created 19.08.2026, 06:10:52 (CET)*